            ...
            when (binaryExpr.operator.type) {
                PLUS -> {
                    ...
                    composer.helper("Main", "add", stackInputSize = 2, stackResultSize = 1) {
                        val (nonNumeric, addStringDouble, addDoubleString, addCombination, throwLabel) = labels(5)
                        aload_0()
                        ifnull(throwLabel)
                        aload_1()
                        ifnull(throwLabel)
                        ...
                        label(addStringDouble)
                        aload_0()
                        instanceof_("java/lang/String")
                        ifeq(addDoubleString)
                        aload_1()
                        instanceof_("java/lang/Double")
                        ifne(addCombination)
